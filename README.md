...
| [User Roles & Permissions](docs/roles-and-permissions.md) | The admin-editable permission matrix (roles x modules x actions), the 48-report access layer, multi-role profiles, and why reports carry no export |
